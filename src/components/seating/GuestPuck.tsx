...
interface Props {
  ...
  // Next-free-seat placement (drag/select share the same path).
  onSeat: (personId: string, locationId: string) => void;
...
export default function GuestPuck({
  ...
  return (
    <div
      ...
      className={`group flex items-center gap-2 rounded-lg border bg-surface-2 px-2 py-1.5 text-sm transition ${
